...
export default function CheckoutPage() {
  ...
  React.useEffect(() => {
    if (typeof window !== 'undefined') {
      ...
      // Preload Razorpay SDK for instant payment gateway opening
  ...
  const handlePayment = async () => {
    ...
    const options = {
      ...
      amount: totalCommitment * 100, // ₹499 in paisa
      currency: "INR",
      name: "AMEC Technology",
      description: "Security Consultation Booking",
      ...
      handler: async function (response: any) {
        ...
        localStorage.setItem('checkout_date', selectedDate ? selectedDate.toDateString() : '');
        localStorage.setItem('checkout_timeSlot', selectedTimeSlot);
        
        // Run saving in the background without blocking the UI transition
      ...
      notes: {
        ...
        application: application === 'Other' ? customApplication : application,
        preferred_date: selectedDate ? selectedDate.toDateString() : '',
          ...
          <div className="lg:col-span-5 lg:sticky lg:top-32 flex flex-col gap-6">
            ...
            <div className="border border-zinc-200 rounded-2xl sm:rounded-3xl p-4 sm:p-6 md:p-8 bg-white shadow-sm flex flex-col gap-5 sm:gap-6">
              ...
              <div className="flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-1.5 text-xs text-emerald-700 bg-emerald-50 border border-emerald-200/80 px-2.5 py-1.5 rounded-lg mt-1 font-semibold">
                  <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" className="shrink-0 text-emerald-600">
                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/>
                    <path d="m9 12 2 2 4-4"/>
                  </svg>
                  <span>Amount Fully Refundable</span>
                </div>
              </div>
              ...
              <div className="text-[11px] text-zinc-500 font-medium text-center flex items-center justify-center gap-1.5 -mt-2">
