          ...
          <div className="max-w-[1440px] mx-auto">
            ...
            <div className="lg:hidden bg-[#f0f4f8] rounded-[32px] p-6 flex flex-col gap-5 shadow-sm border border-zinc-200/50 max-w-lg mx-auto">
              ...
              <div className="flex items-start gap-3 mt-1">
                ...
                <div className="flex flex-col gap-2 text-xs md:text-sm text-zinc-600 font-medium leading-relaxed font-sans">
                  <p>
                    <span className="font-bold text-zinc-800">Sales Office:</span> 868, 25th Main Road, HSR Layout, Sector-1, Bengaluru, KA, India - 560102
                  </p>
                  <p>
                    <span className="font-bold text-zinc-800">Factory Address:</span> Plot No. 5A, 14A, Hingna MIDC, Digdoh, Nagpur, MH, India - 440016
                  </p>
                </div>
              </div>
